...
public class MainActivity extends FragmentActivity {
	...
	private void initSettingDialog() {
		...
		final String[] commants = { "时间设置", "闹钟设置", "获取设备闹钟列表请求", "计步目标设定",
				"用户信息设置命令", "防丢设置:1", "久坐提醒设置", "出厂设置", "名字设置", "设置图片1组","清空图片0组",
				"设置图片文字1组","清空图片文字0组","设置图片0组","设置图片文字0组","设置图片2组","设置图片3组","设置图片4组",
				"设置图片文字2组", "设置图片文字3组", "设置图片文字4组","防丢设置:0", "防丢设置:2" };
		builder.setItems(commants, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				case 1:
					...
					byte[] alarmToBytes1 = Utils.alarmToBytes1();
					byte[] alarmToBytes2 = Utils.alarmToBytes2();
					byte[] alarmToBytes3 = Utils.alarmToBytes3();
				...
				case 9: // 图片设置
					...
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Home),0,data,128*0,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Party),0,data,128*1,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.BBQ),0,data,128*2,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Reading),0,data,128*3,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Watch_TV),0,data,128*4,128);
					updateList(dAddress, "cmd:0x0B," + commants[9] + " :"+ index1);
				...
				case 11: // 图片文字设置
					...
					String [] image_name = {"Home","Party","BBQ","Reading","Watch TV"}; 
					updateList(dAddress, "cmd:0x0D," + commants[11] + " :" +n1 + ",name = "+Arrays.toString(image_name) );
					writeImageName(dAddress, 0x0D, n1,image_name);
					break;
				case 12: // 清空图片文字组
					byte[] indexNameClear = { 0x00};
					updateList(dAddress, "cmd:0x0E," + commants[12] + " :"
							+ Arrays.toString(Utils.byteTo16String(indexNameClear)));
					write(dAddress, indexNameClear.length, 0x0E, indexNameClear);
					break;
				case 13: // 图片0组
					byte[] data13  = new byte [128*8];
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Self) ,0,data13,128*0,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Pet) ,0,data13,128*1,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Kids) ,0,data13,128*2,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Pizza) ,0,data13,128*3,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Music) ,0,data13,128*4,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Really) ,0,data13,128*5,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Whaaaaat) ,0,data13,128*6,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.WTF) ,0,data13,128*7,128);
					int index0 = 0;
					updateList(dAddress, "cmd:0x0B," + commants[13] + " :"+ index0);
					writeImage(dAddress, 0x0B, index0,data13);
					break;
				case 14: // 图片文字设置
					int nn = 0; //那一组图片的文字 0~9
					String [] image_name_0 = {"Self","Pet","Kids","Pizza","Music","Really","Whaaaaat","WTF" }; 
					updateList(dAddress, "cmd:0x0D," + commants[14] + " :" +nn + ",name = "+Arrays.toString(image_name_0) );
					writeImageName(dAddress, 0x0D, nn,image_name_0);
					break;
				case 15: // 设置图片2组 Love
					int imageIndex2 = 2;
					byte[] image_byte2  = new byte [128*6];
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Love) ,0,image_byte2,128*0,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Broken_Heart) ,0,image_byte2,128*1,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Fine_Dining) ,0,image_byte2,128*2,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Romantic) ,0,image_byte2,128*3,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Sex) ,0,image_byte2,128*4,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Soaking) ,0,image_byte2,128*5,128);
					
					updateList(dAddress, "cmd:0x0B," + commants[15] + " :"+ imageIndex2);
				...
				case 16: // 设置图片3组 Work
					...
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Work) ,0,image_byte3,128*0,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Phone_Call) ,0,image_byte3,128*1,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Email) ,0,image_byte3,128*2,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Meeting) ,0,image_byte3,128*3,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Daydream) ,0,image_byte3,128*4,128);
					
					updateList(dAddress, "cmd:0x0B," + commants[16] + " :"+ imageIndex3);
					writeImage(dAddress, 0x0B, imageIndex3,image_byte3);
					break;
				case 17: // 设置图片4组 Workshop
					int imageIndex4 = 4;
					byte[] image_byte4  = new byte [128*4];
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Workshop) ,0,image_byte4,128*0,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Sculpture) ,0,image_byte4,128*1,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Painting) ,0,image_byte4,128*2,128);
					System.arraycopy(Utils.intArraysTobyteArrays(Image.Craft) ,0,image_byte4,128*3,128);
					
					updateList(dAddress, "cmd:0x0B," + commants[17] + " :"+ imageIndex4);
					writeImage(dAddress, 0x0B, imageIndex4,image_byte4);
					break;
				case 18: // 设置图片文字2组
					int nameIndex2 = 2; //那一组图片的文字 0~9
					String [] image_name_2 = {"Love","Broken","Fine","Romantic","Sex","Soaking"}; 
					updateList(dAddress, "cmd:0x0D," + commants[18] + " :" +nameIndex2 + ",name = "+Arrays.toString(image_name_2) );
					writeImageName(dAddress, 0x0D, nameIndex2,image_name_2);
					break;
				case 19: // 设置图片文字3组
					int nameIndex3 = 3; //那一组图片的文字 0~9
					String [] image_name_3 = {"Work","PhoneCal","Email","Meeting","Daydream"}; 
					updateList(dAddress, "cmd:0x0D," + commants[19] + " :" +nameIndex3 + ",name = "+Arrays.toString(image_name_3) );
					writeImageName(dAddress, 0x0D, nameIndex3,image_name_3);
					break;
				case 20: // 设置图片文字4组
					int nameIndex4 = 4; //那一组图片的文字 0~9
					String [] image_name_4 = {"Workshop","Sculptur","Painting","Craft"}; 
					updateList(dAddress, "cmd:0x0D," + commants[20] + " :" +nameIndex4 + ",name = "+Arrays.toString(image_name_4) );
					writeImageName(dAddress, 0x0D, nameIndex4,image_name_4);
					break;
				case 21: // 防丢设置0
					byte[] dd1 = { 0x00 };
					updateList(dAddress, "cmd:0x06," + commants[21] + " :"
							+ Arrays.toString(Utils.byteTo16String(dd1)));
					write(dAddress, dd1.length, 0x06, dd1);
					break;
				case 22: // 防丢设置2
					byte[] dd2 = { 0x02 };
					updateList(dAddress, "cmd:0x06," + commants[22] + " :"
							+ Arrays.toString(Utils.byteTo16String(dd2)));
					write(dAddress, dd2.length, 0x06, dd2);
					break;
				}
			}
		});
...
//		}
	...
	private void initSecurityDialog() {
		...
		final String[] commants = { "手机请求删除绑定", "超级绑定", "用户登录请求",
				"手机请求蓝牙设备MAC地址", "手机请求蓝牙设备E号", "手机请求绑定", "请求获得设备特性", "请求断开" };
		builder.setItems(commants, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				switch (which) {
	...
	private void initSportsDialog() {
		...
		final String[] commants = { "请求实时运动数据", "请求历史运动数据(这个已经包含有简单的历史睡眠时间了)",
				...
				"请求挪动历史睡眠数据指针","请求当前位置动作数据","请求历史位置动作数据  ","请求挪动历史位置动作数据(*)" };
		...
		builder.setItems(commants, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				case 6:
					...
					updateList(dAddress,"cmd:0x39,"+ commants[6]+ " :"+ Arrays.toString(
							Utils.byteTo16String(sleepzhizhen))+ "，挪动时间：" + "2016-12-17 00:00");
				...
				case 8:
					...
					updateList(dAddress, "cmd:0x3B," + commants[8] + " :"
							+ Arrays.toString(Utils.byteTo16String(hislocaiton))
							+ ",请等待，历史数据在后台请求");
					write(dAddress, hislocaiton.length, 0x3B, hislocaiton);
					break;
				case 9:
					byte[] locaitonTime = Utils.record_date(2016, 12, 17, 0); // 年，月，日，时
					updateList(dAddress,"cmd:0x3C,"+ commants[9]+ " :"+ Arrays.toString(
							Utils.byteTo16String(locaitonTime))+ "，挪动时间：" + "2016-12-17 00:00");
	...
	private void initCheersDialog() {
		...
		final String[] commants = {"请求药品剂量数据","请求删除药品剂量数据" ,"请求设置药品类型", "请求实时水温数据 ", "请求实时水量数据", "请求历史水温数据", "请求历史水量数据",
				"请求好友列表","水杯参数设置(*)"};
		builder.setItems(commants, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				...
				case 0:
					...
					updateList(dAddress, "cmd:0x59," + commants[0] + " :"
							+ Arrays.toString(Utils.byteTo16String(zx)) + ",请等待，历史数据在后台请求");
...
//					除需要 400ms，APP 在断开连接后，请等待 4 秒以上才开始重新连接。
	...
	private void initHealthDialog() {
		...
		final String[] commants = { "请求实时心率数据 ", "请求历史心率数据", "请求体温数据",
				"请求历史温度数据", "请求挪动历史心率数据指针", "请求挪动历史体温数据指针" };
		builder.setItems(commants, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				System.out.println("dBleDevice:" + dBleDevice.getAddress());
