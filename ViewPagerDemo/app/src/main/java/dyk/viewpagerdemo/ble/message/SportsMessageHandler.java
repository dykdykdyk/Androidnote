...
//				System.out.println(a[i] + "--->" + b[i] + "--->" + c[i]);
			...
			int steps = UtilTools.bytesToInt2(a, 0);
			int distance = UtilTools.bytesToInt2(b, 0);
			int calory = UtilTools.bytesToInt2(c, 0);
...
//					System.out.println(getCount+"-----sports----" + isSend);
      ...
      byte [] alTemperature = {data[12],data[13]};
			float atmospheric = UtilTools.bytesToInt2(at, 0) / 1000f / 100f;
			float altitude = (UtilTools.bytesToInt2(al, 0)) / 100f;
      float ambient = (UtilTools.dykbytesToInt2(alTemperature, 0))/10f;
