...
public class Fragment_Breathing extends LinearLayout {
    LinearLayout linearLayout ;
    public Fragment_Breathing(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.item_home_breathing,this);
