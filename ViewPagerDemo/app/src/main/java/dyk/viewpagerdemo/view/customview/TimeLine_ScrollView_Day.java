...
public class TimeLine_ScrollView_Day extends LinearLayout {
    /**
    ...
    private int mHighLightItem = 0; //默认选中的item
    public TimeLine_ScrollView_Day(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.timeline_scrollview,this);
        titleList = DateHelper.getTimeOfDay();
        ...
        //设置适配器
        mAdapter = new RecyclerViewAdapter(context, titleList,5);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.highlightItem(mHighLightItem-2);
