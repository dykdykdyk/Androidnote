...
public class TimeLine_ScrollView_Month extends LinearLayout {
    /**
    ...
    public TimeLine_ScrollView_Month(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.timeline_scrollview,this);
        titleList = DateHelper.getTimeOfMonth();
