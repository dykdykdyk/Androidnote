...
public class Fragment_Altitude extends LinearLayout {
    LinearLayout linearLayout ;
    public Fragment_Altitude(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.item_home_altitude,this);
