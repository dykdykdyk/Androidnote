...
public class MeasureTwo_View extends View {
    //弧形开始的角度
    ...
    //里面半圆的半径
    private int innerRadius = dp2px(90);
    //最内层的padding
    private int innerPadding = dp2px(6);
    //外两层的padding
    private int outerPadding = dp2px(15);
    //进度条的宽度
    ...
    public MeasureTwo_View(Context context) {
        this(context, null);
    }

    public MeasureTwo_View(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MeasureTwo_View(Context context, AttributeSet attrs, int defStyleAttr) {
