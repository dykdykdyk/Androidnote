...
public class MeasureThree_Blood_Oxygen_View extends View {
    //弧形开始的角度
    ...
    //外两层的padding
    private int outerPadding = dp2px(17);
    //进度条的宽度
    ...
    public MeasureThree_Blood_Oxygen_View(Context context) {
        this(context, null);
    }

    public MeasureThree_Blood_Oxygen_View(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MeasureThree_Blood_Oxygen_View(Context context, AttributeSet attrs, int defStyleAttr) {
