...
public class SwipereFresh_HeadView extends LinearLayout implements CustomSwipeRefreshLayout.CustomSwipeRefreshHeadLayout {
    ...
    public SwipereFresh_HeadView(Context context) {
        super(context);
        setupLayout();
    }
    ...
    private void setupLayout() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.swiperefresh_head_layout, null);
        ...
        switch (stateCode) {
            ...
            case CustomSwipeRefreshLayout.State.STATE_REFRESHING:
                if (stateCode != lastStateCode) {
                    ...
                    mImageView.setVisibility(View.VISIBLE);
                    mImageView.setImageResource(R.drawable.my_refresh_progress_bar);
//                    mProgressBar.setVisibility(View.VISIBLE);
                    mMainTextView.setText("    正在同步数据   ");
                    mMainTextView.setTextColor(Color.RED);
                }
                break;
