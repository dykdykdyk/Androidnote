...
import dyk.viewpagerdemo.view.fragment.Fragment_Heart_Rate;
...
public class Heart_Rate_Activity extends FragmentActivity {
    ...
    Fragment_Heart_Rate fragment_heart_rate;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment_heart_rate =new Fragment_Heart_Rate();
        ...
        FragmentTransaction    transaction = manager.beginTransaction();
        transaction.add(R.id.step_content, fragment_heart_rate,"11");
        transaction.commit();
    }
}
