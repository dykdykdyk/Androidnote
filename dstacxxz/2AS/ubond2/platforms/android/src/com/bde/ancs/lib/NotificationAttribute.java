...
public class NotificationAttribute {
	...
	public byte[] doCommand2(ANCSNotification sbn, HashMap<String, Attribute> attributes) throws UnsupportedEncodingException{
		byte []ret = null;
		switch (mAttributeID) {
		case 0:
			...
			} else */if (appIdentifier.equalsIgnoreCase("com.ble.ancs.androidancs")) {
				appIdentifier = "com.apple.mobilephone";
