...
- (void)elcImagePickerController:(ELCImagePickerController *)picker didFinishPickingMediaWithInfo:(NSArray *)info {
    ...
    [[[NSHomeDirectory() stringByAppendingPathComponent:@"Documents"] stringByAppendingPathComponent:@"imagePicker"]stringByDeletingPathExtension];
    NSString *fullPath = [[NSHomeDirectory() stringByAppendingPathComponent:@"Documents"] stringByAppendingPathComponent:@"imagePicker"];
	...
	for (NSDictionary *dict in info) {
        ...
        do {
            ...
            fullPath = [NSString stringWithFormat:@"%@%d", fullPath, 01];
            
        } while ([fileMgr fileExistsAtPath:fullPath]);
        ...
        @autoreleasepool {
            ...
            if (![data writeToFile:fullPath options:NSAtomicWrite error:&error]) {
                ...
                [resultStrings addObject:[[NSURL fileURLWithPath:fullPath] absoluteString]];
            }
        }
