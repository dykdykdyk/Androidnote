    ...
    switch (options.destinationType) {
        ...
        case DestinationTypeFileUri:
        {
            ...
            if (data) {
                ...
                [[NSHomeDirectory() stringByAppendingPathComponent:@"Documents"] stringByDeletingPathExtension];
                ...
                if (![data writeToFile:fullPath options:NSAtomicWrite error:&error]) {
                    ...
                    result = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:[[self urlTransformer:[NSURL fileURLWithPath:fullPath]] absoluteString]];
                }
            }
        }
            break;
