...
public class LineChart_Scroll extends Activity  {
...
//                for (int j = 0; j < 25; j++) {
//                    ReFreshLineChart(j+"", new Random().nextInt(0) + j,lineChart,values1);
//                }
                ReFreshLineChart(1+"",10,lineChart,values1);
                ReFreshLineChart(2+"",12,lineChart,values1);
                ReFreshLineChart(3+"",14,lineChart,values1);
                ReFreshLineChart(4+"",15,lineChart,values1);
                ReFreshLineChart(6+"",0,lineChart,values1);
                ReFreshLineChart(7+"",0,lineChart,values1);
                ReFreshLineChart(8+"",18,lineChart,values1);
            }
        });
//创建描述信息
