 ...
 *
 *     ObjectAnimator a = ObjectAnimator.ofFloat(measureOne_view, "Progress", 0.0f, tempanimator);
 a.setInterpolator(new AccelerateDecelerateInterpolator());
 a.setDuration(500);
 a.start();
 */

public class MeasureOne_View extends View {
    //弧形开始的角度
    private static final int startAngle = 180;
    //弧面所跨的弧度
    private static final int sweepAngle = 180;
    //里面数字的单位
    private static final String unint = "次/分";
    //每隔多少画一个刻度
    ...
    public MeasureOne_View(Context context) {
        this(context, null);
    }

    public MeasureOne_View(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MeasureOne_View(Context context, AttributeSet attrs, int defStyleAttr) {
