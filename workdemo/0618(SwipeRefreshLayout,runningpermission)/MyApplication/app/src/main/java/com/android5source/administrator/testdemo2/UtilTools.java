...
public class UtilTools {
    ...
    public static  final String REMIND_QQ_SELECTSTATUS ="remind_qq_selectstatus";//qq(标识)
    ...
    public static  String EDIT_CLOCK_FIRST_LEFTTIME ="eidt_clock_first_lefttime";//first_left
    public static  String EDIT_CLOCK_FIRST_RIGHTTIME ="eidt_clock_first_righttime";//first_left
    public static  String EDIT_CLOCK_FIRST_REPEAT ="eidt_clock_first_repeat";//first_left
    public static  String EDIT_CLOCK_FIRST_VIBRATE ="eidt_clock_first_vibrate";//first_left

    public static  String EDIT_CLOCK_SECOND_LEFTTIME ="eidt_clock_second_lefttime";//first_left
    public static  String EDIT_CLOCK_SECOND_RIGHTTIME ="eidt_clock_second_righttime";//first_left
    public static  String EDIT_CLOCK_SECOND_REPEAT ="eidt_clock_second_repeat";//first_left
    public static  String EDIT_CLOCK_SECOND_VIBRATE ="eidt_clock_second_vibrate";//first_left

    public static  String EDIT_CLOCK_THIRD_LEFTTIME ="eidt_clock_third_lefttime";//first_left
    public static  String EDIT_CLOCK_THIRD_RIGHTTIME ="eidt_clock_third_righttime";//first_left
    public static  String EDIT_CLOCK_THIRD_REPEAT ="eidt_clock_third_repeat";//first_left
    public static  String EDIT_CLOCK_THIRD_VIBRATE ="eidt_clock_third_vibrate";//first_left
    public static  String CLOCK_SETTING_IMAGE_FIRST ="clock_setting_image_first";//first_left
...
//	}
    ...
    //拼字符串
    public static String getMessageString(String title,String content,int returnlength){
        title=title+content;
        if(title.length()==returnlength){
            return title;
        }else if(title.length()>returnlength){
            title=title.substring(0,returnlength);
            return title;
        }else if(title.length()<returnlength){
            return  title;
        }
    ...
    //string change Unicode
    public static byte[] changeUnicode(String a){
        byte [] call = new byte[0];
        try {
            call = a.getBytes("Unicode");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        byte[] bt = new byte[8];
        System.arraycopy(call, 2, bt, 0, call.length-2);
        return  bt;
    }
    /**用户信息设置转换*/
...
//		by[3] =   (byte) type;
    ...
    public static void alarm1(int y ,int m, int d, int h,int mi ,int dayflags,int isopen,int alarmID){
        silentYear1 = y;
        silentMonth1 = m;
        silentDay1 = d;
        silentHour1 =h;
        silentMinute1 = mi;
        silentWeekDay1 = dayflags;
        isAlarm1 = isopen;
        alarm_index1 = alarmID;
    }
    public static void alarm2(int y ,int m, int d, int h,int mi ,int dayflags,int isopen,int alarmID){
        silentYear2 = y;
        silentMonth2 = m;
        silentDay2 = d;
        silentHour2 =h;
        silentMinute2 = mi;
        silentWeekDay2 = dayflags;
        isAlarm2 = isopen;
        alarm_index2 = alarmID;
    }
    public static void alarm3(int y ,int m, int d, int h,int mi ,int dayflags,int isopen,int alarmID){
        silentYear3 = y;
        silentMonth3 = m;
        silentDay3 = d;
        silentHour3 =h;
        silentMinute3 = mi;
        silentWeekDay3 = dayflags;
        isAlarm3 = isopen;
        alarm_index3 = alarmID;
    }
    /***
     * 添加一个闹钟
     */
    ...
    public static int getCounts(String name){
        int counts =0;
        for(int i =0;i<name.length()/2;i++){
            String temp =name.substring(2*i,2*(i+1));
            if(temp.equals("周日")){
                counts=counts+ 64;
            }if(temp.equals("周一")){
                counts=counts+ 1;
