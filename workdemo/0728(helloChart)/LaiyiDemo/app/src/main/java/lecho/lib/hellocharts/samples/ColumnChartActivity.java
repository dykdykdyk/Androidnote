...
import static lecho.lib.hellocharts.samples.LineColumnDependencyActivity.PlaceholderFragment.months_dyk;
        ...
        private void generateDefaultData() {
            ...
            for (int i = 0; i < numColumns; ++i) {
                ...
                for (int j = 0; j < numSubcolumns; ++j) {
                    values.add(new SubcolumnValue((float) Math.random() * 500f + 5, ChartUtils.pickColor()));
                }

                axisValues.add(new AxisValue(i).setLabel(months_dyk[i]));
...
//                data.setAxisYLeft(axisY);
            ...
            //设置缩放
            Viewport maxV=chart.getMaximumViewport();
            chart.setMaximumViewport(new Viewport(maxV.left, maxV.top * 0.3f,
